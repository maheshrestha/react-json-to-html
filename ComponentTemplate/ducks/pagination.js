...
export type PaginationAction =
  | {| type: 'pagination/SET_TOTAL_ENTRIES', totalEntries: number |}
  | {| type: 'pagination/SET_PER_PAGE_SIZE', perPageSize: number |}
  | {| type: 'pagination/SET_CURRENT_PAGE', currentPage: number |};
...
// REDUCERS
export default function reducer<T: PaginationState>(
